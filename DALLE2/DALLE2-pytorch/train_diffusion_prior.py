...
if __name__ == "__main__":
    ...
    # 测试模块
    # config = TrainDiffusionPriorConfig.from_json_path("configs/train_prior_config.example.json")
    # diffusion_prior = config.prior.create()
    # print(diffusion_prior)
    # torch.save(diffusion_prior.state_dict(), "tmp.pt")
