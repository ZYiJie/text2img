...
# python cal_retrieval.py --feat_load_dir ./logs/feature/ance_trip
...
# AIC caption dataset
# image feature： [30000, 2048/768]  - [sample_num, featdim]
# text feature:   [30000, 2048/768] - [sample_num, featdim]
